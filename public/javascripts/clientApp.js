...
function clientApp(){
	...
	// Button setup
	setupButtons();
	// Setup drowdown buttons here (cant be done in setupButtons because that runs before cgApp()'s constructor is done and it seems undefined at that moment).
	...
	// TODO
	// run introView for first one only.
